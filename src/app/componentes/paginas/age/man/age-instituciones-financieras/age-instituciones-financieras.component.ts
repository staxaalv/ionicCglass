...
@Component({
  selector: 'app-age-instituciones-financieras',
  templateUrl: './age-instituciones-financieras.component.html',
  styleUrls: ['./age-instituciones-financieras.component.css']
})
export class AgeInstitucionesFinancierasComponent extends ACComponent {

  constructor(protected ageService: AgeService, protected sanitizer: DomSanitizer) { 
    super(ageService, sanitizer, "Lista Instituciones Financieras", ageService.INSTITUCIONES_FINANCIERAS_URL, true, ageService.subjectOpcionesInstitucionFinanciera);
  }
